...
public class MockTestRunnerStreamerFunction extends GoogleCloudEventHarness {
  private static final Logger logger =
      Logger.getLogger(MockTestRunnerStreamerFunction.class.getName());

  @Override
  public void doAccept() {
    try {
      String expectedBucket = CF_ENV.get("GOOGLE_BUCKET");
